...
Our https://www.jbang.dev/usage/downloads/[download statistics page] deliberately separates out `version.txt` (which JBang uses for update checks) and also excludes checksums and signatures. 
