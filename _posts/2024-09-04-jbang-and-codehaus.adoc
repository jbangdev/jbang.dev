...
Other founding projects are https://in.relation.to/2024/04/09/hibernate-to-commonhaus/[Hibernate], https://github.com/FasterXML/jackson[Jackson], https://docs.openrewrite.org/[OpenRewrite], https://jreleaser.org/[JReleaser] & https://morphia.dev/[Morphia]. 
